...
public void givenPremiumAndNormalRideForUserId_ShouldReturnInvoiceSummary() {
    Ride[] rides1 = {new Ride(10,5,RideType.PREMIUM),new Ride(0.1,3,RideType.PREMIUM),new Ride(5,9,RideType.PREMIUM),new Ride(9,8,RideType.PREMIUM)};
        Ride[] rides2 = {new Ride(10,6,RideType.NORMAL),new Ride(0.1,3,RideType.NORMAL),new Ride(5,9,RideType.NORMAL),new Ride(9,8,RideType.NORMAL)};
        RideRepository.customerList.add(new Customer(1,rides1));
        RideRepository.customerList.add(new Customer(2,rides2));
        Invoice actualInvoice = RideRepository.generateInvoiceByUserId(2);
        Invoice expectedInvoice = new Invoice(268.0,4,67);
